...
# 🎮 **CeloTrivia – Web3 Mobile Trivia Game Powered by Celo MiniPay**

A mobile-first, tokenized trivia game built for the **Celo MiniPay Hackathon**.
...
* Solid Web3 engineering
* Great product design
* Mobile-first blockchain UX
* Understanding of Celo + MiniPay

Perfect for hackathons, demos, and recruiters.
